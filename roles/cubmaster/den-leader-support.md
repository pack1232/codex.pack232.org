# Cubmaster: Supporting Den Leaders
...
1. Introduce them to the Committee Chair and other leaders
2. Ensure they have completed YPT and den leader position-specific training
3. Walk them through Scoutbook — this is how advancement is tracked
4. Connect them with an experienced den leader as a peer mentor
5. Provide a copy of the rank-specific den leader guide (see `den-leader/ranks/`)
6. Ensure they understand the shared leadership model (Lions and Tigers)
...
Track training status via [my.Scouting.org](https://my.scouting.org/) under the pack's leader roster.
...
See [`../den-chief/README.md`](../den-chief/README.md) for the full den chief role guide.
...
1. Identify a parent in the den willing to step up (Cubmaster and Committee Chair work together)
2. Use the *Selecting Cub Scout Leadership Guide* (see `docs/Training/Positions/Committee Chair/Selecting Cub Scout Leadership Guide.md`)
3. Ensure the Cubmaster or Assistant Cubmaster provides interim support to the den
...
- [`../den-leader/README.md`](../den-leader/README.md) — full den leader role guide
- `docs/Training/Positions/Den Leader/Den Leader Guide.md`
