...
Each den should have an Assistant Den Leader. See the org chart in the [roles README](../../README.md) for current assignments (all currently vacant).

## Key Resources

- [Den Leader role overview](../README.md)
