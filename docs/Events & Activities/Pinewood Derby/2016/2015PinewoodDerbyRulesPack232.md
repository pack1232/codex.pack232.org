---
title: "2015Pinewood Derby Rules Pack232"
description: "2015 Pinewood Derby Rules From Wikibooks, open books for an open world"
source_file: "2015PinewoodDerbyRulesPack232.doc"
converted_date: "2026-03-06"
original_format: "doc"
author: "the parts"
tags: ["pinewood derby", "rules", "service", "committee", "registration"]
category: "2016"
draft: false
---

2015 Pinewood Derby Rules
From Wikibooks, open books for an open world

INCLUDEPICTURE "http://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Derby_icon.svg/250px-Derby_icon.svg.png" \* MERGEFORMATINET

INCLUDEPICTURE "http://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Pinewood.jpg/300px-Pinewood.jpg" \* MERGEFORMATINET
The rules that come in the Grand Prix Pinewood Derby Kit (BSA Kit 17006) are known as the "Rules in the Box."
Material: Race cars shall be constructed for this event from the parts contained in the Official Grand Prix Pinewood Derby Kit (referred to below as the kit) as sold by the Scout Service Center, [for the District in which the race is run]. The main body structure must be made of wood. Cars that were purchased completed may not be used.
Size: Race cars may be no longer than 7 inches, nor wider than 2 3/4 (2.75) inches, nor taller than 3 inches, as determined by the official gages during race day inspection. (Underside clearance of at least 3/8 (0.375) inches and inside wheel to wheel clearance of at least 1 3/4 (1.75) inches is recommended, so that the car will run on the racetrack. Adequate clearance is the responsibility of the race car builder.)   Center Rail Width: Must clear center guide rails, typically no less than 1-3/4 inches minimum. Bottom: No less than 3/8 inches from track surface between center rails.  Depending upon the track, the front of the car may rest against a short starting pin. Therefore the front bottom of the car which rests on the pin is no higher than 1" above the track, and the front end must be at least
...
Gravity Powered: The car must be free-wheeling, with no starting devices.  For example,  the race car may not be constructed or treated in such a way that the track's starting mechanism imparts momentum to the car. (For instance, this provision disqualifies cars with sticky substances on the front of the car and protrusions which may catch on the starting pin.)
Lubricants: Over-application of lubricant which results in excessive shedding onto the track is not allowed. Only dry lubricants such as graphite or powdered Teflon "white lube" will be allowed for lubricating the wheels.
Details: Steering wheels, drivers and other details are permissible as long as these do not exceed the maximum length, width and weight specifications.
...
No part of the car or any attachment to the car may be capable of coming into contact with the track other than the wheels. AXLES: Grooves are allowed, the depth of the groove(s) is not limited so long as the journal portion of the axle (the part the wheel rides on) is no less than the stated minimum diameter.

## Good Sportsmanship And Behavior Is Expected.
