...
The Cubmaster (often through the Assistant Cubmaster) requests den chiefs from local Scouts BSA troops — specifically, the pack works with local troops to supply den chiefs. The request goes to the Scoutmaster, who selects an appropriate Scout (typically First Class or above).

**Current troop relationship**: the pack works with local Scouts BSA troops in the your district.
